...
export const Navbar = () => {
    ...
    return (
        <header className={`fixed top-0 left-0 right-0 transition-all duration-500 ${isScrolled ? "glass-strong py-3": "bg-transparent py-5"} py-5 z-50`}>
            <nav className="container mx-auto px-6 flex justify-between">
                <a href="#" className="text-xl font-bold tracking-tight hover:text-primary">
                    YR <span className="text-primary">.</span>
                </a>
                {/* Desktop View Nav */}
